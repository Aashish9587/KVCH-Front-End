...
const Transactions = () => {
    ...
    useEffect(()=>{
        const getTransactions = async ()=>{
            const list = await axios.get(`https://roxiler-backend-alpha.vercel.app?page=${page}&perPage=10&search=${searchInput}&month=${selectedMonth}&page=${page}&search=${searchInput}&perPage=10`)
